package com.isi.ExamenSpringboot.servivce;

import com.isi.ExamenSpringboot.entity.CVEntity;
import com.isi.ExamenSpringboot.entity.Role;
import com.isi.ExamenSpringboot.repository.ICVRepository;
...
public class CVService implements UserDetailsService {
    ...
    public List<CVEntity> findAll(){return icvRepository.findAll();}
